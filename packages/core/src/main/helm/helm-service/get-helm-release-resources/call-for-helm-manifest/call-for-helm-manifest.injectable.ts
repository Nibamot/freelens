...
import type { KubeJsonApiData, KubeJsonApiDataList } from "@nibamot/kube-object";
  ...
  instantiate: (di) => {
    ...
    return async (
      ...
      return {
        ...
        response: yaml.loadAll(result.response, null, { json: true }).filter(isObject) as unknown as KubeJsonApiData[],
      };
    };
  },
});
